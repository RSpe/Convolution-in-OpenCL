...
t = 0:Ts:1-Ts;%linspace(0, (1-Ts), sampleSize); %Duration of the signal(/s).
...
%subplot(3,1,1)
%plot(norm_x, abs(y_freq))
%hold on
%plot(norm_x, abs(lp_fil_freq))
